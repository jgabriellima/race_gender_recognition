...
#    output_logits_sg = tf.stop_gradient(logits)
    ...
    logits_gender, logits_race, end_points = add_layers(logits, is_training=is_training)
...
def read_and_decode(data_file, size = [200, 200], is_training=True, batch_size=8):
    ...
    if is_training:
        ...
        images, genders, races, addresses = tf.train.shuffle_batch([image, gender, race, address], batch_size=batch_size,
    ...
    return images, genders, races, addresses
